        ...
        <div className='container d-flex align-items-center justify-content-center flex-column '>
            <div className='border_full_box'>
                ...
                <div className='input_full_border d-flex justify-content-between'>
                    ...
                    />
                    <button className='task_btn ' onClick={addTask}>Add</button>
                    ...
                    {tasks.map((task, index) => (
                        <li className='d-flex justify-content-between map_border px-3 py-2 '
                            ...
                            style={{
                                ...
                                opacity: task.completed ? 0.7 : 1, // Set opacity based on completion
                            }}>
                            {task.text}
                            <div>
                                ...
                                <button className='edit_btn ' onClick={() => toggleTaskCompletion(index)}>
